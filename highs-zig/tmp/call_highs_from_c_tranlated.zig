...
pub export fn minimal_api() void {
    ...
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(run_status == kHighsStatusOk))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("minimal_api", "call_highs_from_c.c", @as(c_int, 106), "run_status == kHighsStatusOk") else @as(c_int, 0);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(model_status == kHighsModelStatusOptimal))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("minimal_api", "call_highs_from_c.c", @as(c_int, 107), "model_status == kHighsModelStatusOptimal") else @as(c_int, 0);
    ...
    run_status = Highs_lpCall(num_col, num_row, num_nz, a_format, sense, offset, @as([*c]const f64, @ptrCast(@alignCast(&col_cost))), @as([*c]const f64, @ptrCast(@alignCast(&col_lower))), @as([*c]const f64, @ptrCast(@alignCast(&col_upper))), @as([*c]const f64, @ptrCast(@alignCast(&row_lower))), @as([*c]const f64, @ptrCast(@alignCast(&row_upper))), @as([*c]const HighsInt, @ptrCast(@alignCast(&a_start))), @as([*c]const HighsInt, @ptrCast(@alignCast(&a_index))), @as([*c]const f64, @ptrCast(@alignCast(&a_value))), col_value, col_dual, row_value, row_dual, col_basis_status, row_basis_status, &model_status);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(run_status == kHighsStatusOk))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("minimal_api", "call_highs_from_c.c", @as(c_int, 132), "run_status == kHighsStatusOk") else @as(c_int, 0);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(model_status == kHighsModelStatusOptimal))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("minimal_api", "call_highs_from_c.c", @as(c_int, 133), "model_status == kHighsModelStatusOptimal") else @as(c_int, 0);
    _ = printf("\nRun status = %d; Model status = %d\n", run_status, model_status);
    objective_value = offset;
    {
        var i: HighsInt = 0;
    ...
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(run_status == kHighsStatusOk))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("minimal_api", "call_highs_from_c.c", @as(c_int, 160), "run_status == kHighsStatusOk") else @as(c_int, 0);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(model_status == kHighsModelStatusOptimal))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("minimal_api", "call_highs_from_c.c", @as(c_int, 161), "model_status == kHighsModelStatusOptimal") else @as(c_int, 0);
    _ = printf("\nRun status = %d; Model status = %d\n", run_status, model_status);
    objective_value = offset;
    {
        var i: HighsInt = 0;
...
pub export fn minimal_api_qp() void {
    ...
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(run_status == kHighsStatusOk))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("minimal_api_qp", "call_highs_from_c.c", @as(c_int, 239), "run_status == kHighsStatusOk") else @as(c_int, 0);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(model_status == kHighsModelStatusOptimal))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("minimal_api_qp", "call_highs_from_c.c", @as(c_int, 240), "model_status == kHighsModelStatusOptimal") else @as(c_int, 0);
    _ = printf("\nRun status = %d; Model status = %d\n", run_status, model_status);
    objective_value = offset;
    {
        var i: HighsInt = 0;
...
pub export fn minimal_api_mps() void {
    var filename: [*c]const u8 = "../HiGHS/check/instances/avgas.mps";
    _ = &filename;
    var highs: ?*anyopaque = Highs_create();
    _ = &highs;
    var run_status: c_int = undefined;
    _ = &run_status;
    run_status = Highs_readModel(highs, filename);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(run_status == kHighsStatusOk))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("minimal_api_mps", "call_highs_from_c.c", @as(c_int, 290), "run_status == kHighsStatusOk") else @as(c_int, 0);
    run_status = Highs_run(highs);
    var model_status: c_int = Highs_getModelStatus(highs);
    _ = &model_status;
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(run_status == kHighsStatusOk))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("minimal_api_mps", "call_highs_from_c.c", @as(c_int, 294), "run_status == kHighsStatusOk") else @as(c_int, 0);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(model_status == kHighsModelStatusOptimal))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("minimal_api_mps", "call_highs_from_c.c", @as(c_int, 295), "model_status == kHighsModelStatusOptimal") else @as(c_int, 0);
    _ = printf("\nRun status = %d; Model status = %d\n", run_status, model_status);
    ...
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(fabs(objective_function_value + 7.75) < 0.00001))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("minimal_api_mps", "call_highs_from_c.c", @as(c_int, 302), "fabs(objective_function_value+7.75)<1e-5") else @as(c_int, 0);
}
pub export fn full_api() void {
    ...
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(run_status == kHighsStatusOk))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 362), "run_status == kHighsStatusOk") else @as(c_int, 0);
    run_status = Highs_run(highs);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(run_status == kHighsStatusOk))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 367), "run_status == kHighsStatusOk") else @as(c_int, 0);
    model_status = Highs_getModelStatus(highs);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(model_status == kHighsModelStatusOptimal))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 370), "model_status == kHighsModelStatusOptimal") else @as(c_int, 0);
    ...
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(primal_solution_status == kHighsSolutionStatusFeasible))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 382), "primal_solution_status == kHighsSolutionStatusFeasible") else @as(c_int, 0);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(dual_solution_status == kHighsSolutionStatusFeasible))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 383), "dual_solution_status == kHighsSolutionStatusFeasible") else @as(c_int, 0);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(basis_validity == kHighsBasisValidityValid))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 385), "basis_validity == kHighsBasisValidityValid") else @as(c_int, 0);
    var col_value: [*c]f64 = @as([*c]f64, @ptrCast(@alignCast(malloc(@sizeOf(f64) *% @as(c_ulong, @bitCast(@as(c_long, num_col)))))));
    _ = &col_value;
    var col_dual: [*c]f64 = @as([*c]f64, @ptrCast(@alignCast(malloc(@sizeOf(f64) *% @as(c_ulong, @bitCast(@as(c_long, num_col)))))));
    _ = &col_dual;
    ...
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(run_status == @as(c_int, 0)))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 413), "run_status==0") else @as(c_int, 0);
    _ = printf("LP problem has objective sense = %d\n", check_sense);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(check_sense == sense))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 415), "check_sense == sense") else @as(c_int, 0);
    _ = Highs_changeObjectiveSense(highs, kHighsObjSenseMaximize);
    run_status = Highs_run(highs);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(run_status == kHighsStatusOk))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 423), "run_status == kHighsStatusOk") else @as(c_int, 0);
    model_status = Highs_getModelStatus(highs);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(model_status == kHighsModelStatusOptimal))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 426), "model_status == kHighsModelStatusOptimal") else @as(c_int, 0);
    _ = printf("Run status = %d; Model status = %d\n", run_status, model_status);
    _ = Highs_getDoubleInfoValue(highs, "objective_function_value", &objective_function_value);
    _ = Highs_getIntInfoValue(highs, "simplex_iteration_count", &simplex_iteration_count);
    _ = Highs_getIntInfoValue(highs, "primal_solution_status", &primal_solution_status);
    _ = Highs_getIntInfoValue(highs, "dual_solution_status", &dual_solution_status);
    _ = Highs_getIntInfoValue(highs, "basis_validity", &basis_validity);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(primal_solution_status == kHighsSolutionStatusFeasible))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 439), "primal_solution_status == kHighsSolutionStatusFeasible") else @as(c_int, 0);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(dual_solution_status == kHighsSolutionStatusFeasible))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 440), "dual_solution_status == kHighsSolutionStatusFeasible") else @as(c_int, 0);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(basis_validity == kHighsBasisValidityValid))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 442), "basis_validity == kHighsBasisValidityValid") else @as(c_int, 0);
    _ = Highs_getSolution(highs, col_value, col_dual, row_value, row_dual);
    _ = Highs_getBasis(highs, col_basis_status, row_basis_status);
    {
        var i: HighsInt = 0;
    ...
    _ = &check_num_nz;
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(check_num_col == @as(c_int, 0)))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 467), "check_num_col == 0") else @as(c_int, 0);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(check_num_row == @as(c_int, 0)))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 468), "check_num_row == 0") else @as(c_int, 0);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(check_num_nz == @as(c_int, 0)))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 469), "check_num_nz == 0") else @as(c_int, 0);
    ...
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(run_status == @as(c_int, 0)))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 481), "run_status==0") else @as(c_int, 0);
    ...
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(run_status == @as(c_int, 0)))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 484), "run_status==0") else @as(c_int, 0);
    _ = Highs_changeObjectiveSense(highs, kHighsObjSenseMaximize);
    _ = Highs_changeObjectiveOffset(highs, offset);
    run_status = Highs_getObjectiveSense(highs, &check_sense);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(run_status == @as(c_int, 0)))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 493), "run_status==0") else @as(c_int, 0);
    _ = printf("LP problem has objective sense = %d\n", check_sense);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(check_sense == kHighsObjSenseMaximize))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 495), "check_sense == kHighsObjSenseMaximize") else @as(c_int, 0);
    ...
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(run_status == kHighsStatusOk))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 504), "run_status == kHighsStatusOk") else @as(c_int, 0);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(option_type == @as(c_int, 2)))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 505), "option_type == 2") else @as(c_int, 0);
    ...
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(run_status == @as(c_int, 0)))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 521), "run_status==0") else @as(c_int, 0);
    model_status = Highs_getModelStatus(highs);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(model_status == kHighsModelStatusOptimal))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 524), "model_status == kHighsModelStatusOptimal") else @as(c_int, 0);
    _ = printf("\nRun status = %d; Model status = %d\n", run_status, model_status);
    ...
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(run_status == kHighsStatusOk))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 533), "run_status == kHighsStatusOk") else @as(c_int, 0);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(info_type == kHighsInfoTypeDouble))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 534), "info_type == kHighsInfoTypeDouble") else @as(c_int, 0);
    _ = Highs_getDoubleInfoValue(highs, "objective_function_value", &objective_function_value);
    _ = Highs_getIntInfoValue(highs, "simplex_iteration_count", &simplex_iteration_count);
    _ = Highs_getIntInfoValue(highs, "primal_solution_status", &primal_solution_status);
    _ = Highs_getIntInfoValue(highs, "dual_solution_status", &dual_solution_status);
    _ = Highs_getIntInfoValue(highs, "basis_validity", &basis_validity);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(primal_solution_status == kHighsSolutionStatusFeasible))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 543), "primal_solution_status == kHighsSolutionStatusFeasible") else @as(c_int, 0);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(dual_solution_status == kHighsSolutionStatusFeasible))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 544), "dual_solution_status == kHighsSolutionStatusFeasible") else @as(c_int, 0);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(basis_validity == kHighsBasisValidityValid))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 546), "basis_validity == kHighsBasisValidityValid") else @as(c_int, 0);
    _ = Highs_getSolution(highs, col_value, col_dual, row_value, row_dual);
    _ = Highs_getBasis(highs, col_basis_status, row_basis_status);
    {
        var i: HighsInt = 0;
    ...
    run_status = Highs_run(highs);
    _ = Highs_setBoolOptionValue(highs, "output_flag", @as(c_int, 1));
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(run_status == kHighsStatusOk))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 573), "run_status == kHighsStatusOk") else @as(c_int, 0);
    model_status = Highs_getModelStatus(highs);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(model_status == kHighsModelStatusOptimal))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 576), "model_status == kHighsModelStatusOptimal") else @as(c_int, 0);
    _ = printf("\nRun status = %d; Model status = %d\n", run_status, model_status);
    _ = Highs_getDoubleInfoValue(highs, "objective_function_value", &objective_function_value);
    _ = Highs_getIntInfoValue(highs, "simplex_iteration_count", &simplex_iteration_count);
    ...
    _ = Highs_getIntInfoValue(highs, "dual_solution_status", &dual_solution_status);
    _ = Highs_getIntInfoValue(highs, "basis_validity", &basis_validity);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(primal_solution_status == kHighsSolutionStatusFeasible))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 589), "primal_solution_status == kHighsSolutionStatusFeasible") else @as(c_int, 0);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(dual_solution_status == kHighsSolutionStatusNone))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 591), "dual_solution_status == kHighsSolutionStatusNone") else @as(c_int, 0);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(basis_validity == kHighsBasisValidityInvalid))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 593), "basis_validity == kHighsBasisValidityInvalid") else @as(c_int, 0);
    _ = if (__builtin_expect(@as(c_long, @intFromBool(!(mip_node_count == @as(i64, @bitCast(@as(c_longlong, @as(c_int, 1))))))), @as(c_long, @bitCast(@as(c_long, @as(c_int, 0))))) != 0) __assert_rtn("full_api", "call_highs_from_c.c", @as(c_int, 594), "mip_node_count == 1") else @as(c_int, 0);
    _ = Highs_getSolution(highs, col_value, col_dual, row_value, row_dual);
    {
        var i: HighsInt = 0;
        _ = &i;
